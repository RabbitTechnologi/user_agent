...
os.system("clear")
print(logo)
print("\x1b[1;92m ●\033[1;90m USER AGENT SAVE IN >> firefox-ua.txt")
print("\033[1;90m")
print(b1)
print("")
print(b2)
...
open("firefox-ua.txt","a").write(b1+'\n')
open("firefox-ua.txt","a").write(b2+'\n')
open("firefox-ua.txt","a").write(b3+'\n')
open("firefox-ua.txt","a").write(b4+'\n')
open("firefox-ua.txt","a").write(b5+'\n')
